...
my.options$set(
  ...
  showVorlesungsplan = TRUE,   # Zeige die Vorlesungstermine -> In der Datei WMQD-default.Rmd anpassen
  Corona = FALSE
)
...
ChildList <- c(
    {if_else(my.options$get("Corona"),
             'DES-Organisatorisches-CORONA.Rmd',  # 60-min Klausur-Fassung
             'DES-Organisatorisches.Rmd')},
