...
- Die Studierenden können Gründe für den Einsatz von R nennen.
- Die Studierenden können die Unterschiede zwischen R, RStudio und mosaic erläutern.
- Die Studierenden können R in Grundzügen anwenden (wie Datensätze laden und einfache Befehle eingeben).
...
Alternative zur Installation von R: Clouddienst [https://rstudio.cloud/](https://rstudio.cloud/)
...
Internen Datensatz `Births78` laden:^[Falls Sie aktuell noch kein lauffähiges R haben: Für die heutige Vorlesung geht auch [https://fomshinyapps.shinyapps.io/micRo-Births78/](https://fomshinyapps.shinyapps.io/micRo-Births78/)]
