...
- Die Studierenden können R in Grundzügen anwenden (wie Datentabellen laden und einfache Befehle eingeben).
...
Interner Datentabelle `Births78` laden:^[Falls Sie aktuell noch kein lauffähiges R haben: Für die heutige Vorlesung geht auch [https://fomshinyapps.shinyapps.io/micRo-Births78/](https://fomshinyapps.shinyapps.io/micRo-Births78/)]

```{r}
data(Births78)
```

Datentabellebeschreibung (Hilfe zu den Daten):
