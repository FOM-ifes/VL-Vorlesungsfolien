...
<!-- ### Übung  `r nextExercise()`: Zeitreihenanalyse {.exercise type=essay} -->

<!-- Wie könnte ein Modell aussehen, welches die Immobilienpreisentwicklung darstellt? -->


<!-- ::: {.notes} -->
<!-- Z.B. ein additives Modell: $y_t = m_t + s_t + e_t$ mit der Zeit $t$ als erklärende Variable: `Y ~ T`. Ob hier eine Saisonkomponente (z.B. Quartal) vorliegt, müsste untersucht werden. -->
<!-- ::: -->
