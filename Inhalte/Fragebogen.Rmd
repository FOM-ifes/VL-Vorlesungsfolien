...
# `r nextChapter()` Entwicklung des Fragebogens
...
knitr::include_graphics(file.path(pathToImages, "Rating.png"))
```

- Skala mit der Angabe der Ausprägungen pro Antwortmöglichkeit: Ordinalskala
```{r echo=FALSE, out.width = "30%", fig.align="center"}
knitr::include_graphics(file.path(pathToImages, "Ordinalskala.png"))
```

- **Likert-Skala** mit Angabe an den Extrempunkten: Intervallskala
```{r echo=FALSE, out.width = "30%", fig.align="center"}
knitr::include_graphics(file.path(pathToImages, "Intervallskala1.png"))
```

- **Likert-Skala** mit Angabe aller *gleichabständigen* Skalenwerte: Intervallskala
```{r echo=FALSE, out.width = "30%", fig.align="center"}
knitr::include_graphics(file.path(pathToImages, "Intervallskala2.png"))
```
...
knitr::include_graphics(file.path(pathToImages, "Fragen.png"))
```
...
```{r echo=FALSE, out.width = "80%", fig.align="center"}
knitr::include_graphics(file.path(pathToImages, "Fragenaufbau.png"))
```
...
knitr::include_graphics(file.path(pathToImages, "Anschreiben.png"))
```
...
```{r echo=FALSE, out.width = "80%", fig.align="center"}
knitr::include_graphics(file.path(pathToImages, "Datenaufbereitung.png"))
```
