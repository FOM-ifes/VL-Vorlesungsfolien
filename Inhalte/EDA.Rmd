...
mosaicplot(day ~ smoker, data = tips, color = viridis(2, alpha = 0.6), cex = 1.5)
```
...
In welcher Situation beschreibt der arithmetische Mittelwert (vertikale Linie) die Beobachtungen (Punkte) *besser*?
...
```{r Visualisierung_Korrelation, fig.align="center", echo=FALSE, fig.width = 14, fig.asp = 25/40, out.width="60%"}
