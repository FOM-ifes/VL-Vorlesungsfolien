```{r setup-Einfuehrung-Wahrscheinlichkeit, echo=FALSE}
# ---------------------------------------------------------------------------
#% maintainer:
#%   - Karsten Luebke
#%
...
source("../prelude.R")
initPart(
    "Einfuehrung-Wahrscheinlichkeit",  # Dateiname ohne Suffix
...
```
# `r nextChapter()` Wahrscheinlichkeit
...
```{r finish-Einfuehrung-Wahrscheinlichkeit, include=FALSE}
rm(pathToImages)
