...
knitr::include_graphics(file.path(pathToImages, "Wu_etal_2015.png"))
```
...
knitr::include_graphics(file.path(pathToImages, "taxi_pickups_map.png"))
```
:::
...
```{r echo = FALSE, out.width = "70%"}
knitr::include_graphics(file.path(pathToImages, "nyc_taxi_uber_lyft.png"))
```
:::  
</div></div>
::: {.tiny}
