...
:::
::: {.column width="49%"}
```{r ref.label="gf-point-tip-smoker", eval=TRUE, echo=FALSE, out.width = "50%", fig.align="center"}
```
:::
::::::::
...
::: {.scriptsize}
```{r lm-smoker-shuffle-no-eval, out.width = "30%", fig.align="center", eval=FALSE}
set.seed(1896)
