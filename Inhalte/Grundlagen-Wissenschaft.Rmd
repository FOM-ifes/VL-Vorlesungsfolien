...
B.  Das hier Schlaf besser ist als Koffein ist reiner Zufall, in Wirklichkeit ist Koffein besser.
...
Wir können aber z.B. gucken, welche Unterschiede *zufällig* vorkommen würden, wenn es keinen Unterschied geben würde (Modellannahme).
:::
...
*Empirische Evidenz* liefern Daten und deren Analyse, also ***Ja***.
:::
...
- Wie die Kaffemaschine *wirklich* funktioniert, wissen wir nicht, dafür verwenden wir Hypothesen und Modelle.^[Literatur!]
