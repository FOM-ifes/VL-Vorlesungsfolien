...
### Multidimensiononale Skalierung (MDS)
...
2. Die Distanzen zwischen den Objekten werden nun mit den Ähnlichkeiten verglichen. Liegen nun zwei Objekte im Verhältnis zur Ähnlichkeit weit **auseinander/bei einander**, werden sie **aufeinander zu-/voneinander** weg geschoben
...
```{r}
# Download der skalierten aggreguierten Markenbewertungen 
...
### Übung `r nextExercise()`: MDS Lösung {.exercise type=essy}
...
### Übung `r nextExercise()`: Cluster/PCA  {.exercise type=essy}
...
### Übung `r nextExercise()`: Fallstudie/praktische Anwendung zur MDS  {.exercise type=essy}
