...
- Evaluation des Einsates der Conjoint Analyse in der Marketing Controlling Praxis.
...
3.	Entwicklung eines experimentellen Design
...
### Übung `r nextExercise()`: Anforderungen an die Merkamalsausprägungen {.exercise type=A-B-C-D-E answer=A-C-D}
...
knitr::include_graphics(file.path(pathToImages, "Merkmale.png"))
```
...
```{r echo=FALSE, out.width = "80%", fig.align="center"}
knitr::include_graphics(file.path(pathToImages, "Kurznotation.png"))
```
...
### Ausgabe des vollständigen Designs (esten 16 Zeilen)
...
```{r}
set.seed(1986) # Initialisierung eines Zufallsgeneraturs
...
```{r echo=FALSE, out.width = "80%", fig.align="center"}
knitr::include_graphics(file.path(pathToImages, "Stimuli.png"))
```
...
```{r echo=FALSE, out.width = "80%", fig.align="center"}
knitr::include_graphics(file.path(pathToImages, "Choice-Set1.png"))
```
...
Am Beispiel der ersten Auskunftsperson bedeuten die ersten drei Ziffern die Auskunftsperson Nr. 1 und die letzten zwei Ziffern, dass es sich um das erste, zweite, drieet und vierte Choice-Set im Fragebogen handelt. 
...
### Interprataion der Schätzparameter
...
```{r echo=FALSE, out.width = "80%", fig.align="center"}
knitr::include_graphics(file.path(pathToImages, "Rangfolge.png"))
```
...
```{r echo=FALSE, out.width = "80%", fig.align="center"}
knitr::include_graphics(file.path(pathToImages, "Wichtigkeit.png"))
```
